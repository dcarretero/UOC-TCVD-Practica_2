...
> Usamos el lower y upper whiskers para imputar el valor de la media a nuestros valores extremos.

```{r}
dt_winequality$fixed.acidity[which(dt_winequality$fixed.acidity < lower_whisker | dt_winequality$fixed.acidity > upper_whisker)] <- mean(dt_winequality$fixed.acidity, na.rm = TRUE)
```
...
```{r}
dt_winequality$volatile.acidity[which(dt_winequality$volatile.acidity < lower_whisker | dt_winequality$volatile.acidity > upper_whisker)] <- mean(dt_winequality$volatile.acidity, na.rm = TRUE)
```
...
```{r}
dt_winequality$citric.acid[which(dt_winequality$citric.acid < lower_whisker | dt_winequality$citric.acid > upper_whisker)] <- mean(dt_winequality$citric.acid, na.rm = TRUE)
```
...
```{r}
dt_winequality$residual.sugar[which(dt_winequality$residual.sugar < lower_whisker | dt_winequality$residual.sugar > upper_whisker)] <- mean(dt_winequality$residual.sugar, na.rm = TRUE)
```
...
```{r}
dt_winequality$chlorides[which(dt_winequality$chlorides < lower_whisker | dt_winequality$chlorides > upper_whisker)] <- mean(dt_winequality$chlorides, na.rm = TRUE)
```
...
```{r}
dt_winequality$total.sulfur.dioxide[which(dt_winequality$total.sulfur.dioxide < lower_whisker | dt_winequality$total.sulfur.dioxide > upper_whisker)] <- mean(dt_winequality$total.sulfur.dioxide, na.rm = TRUE)
```
...
```{r}
dt_winequality$density[which(dt_winequality$density < lower_whisker | dt_winequality$density > upper_whisker)] <- mean(dt_winequality$density, na.rm = TRUE)
```
...
```{r}
dt_winequality$pH[which(dt_winequality$pH < lower_whisker | dt_winequality$pH > upper_whisker)] <- mean(dt_winequality$pH, na.rm = TRUE)
```
...
```{r}
dt_winequality$sulphates[which(dt_winequality$sulphates < lower_whisker | dt_winequality$sulphates > upper_whisker)] <- mean(dt_winequality$sulphates, na.rm = TRUE)
```
...
```{r}
dt_winequality$alcohol[which(dt_winequality$alcohol < lower_whisker | dt_winequality$alcohol > upper_whisker)] <- mean(dt_winequality$alcohol, na.rm = TRUE)
```
