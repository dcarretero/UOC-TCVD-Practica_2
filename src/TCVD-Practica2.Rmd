...
```{r}
boxplot(dt_red_wines$quality,
        dt_white_wines$quality,
...
>Se puede observar que realmente hay una diferencia en las medias de calidad al ser el p-value mucho menor que el valor de significancia de 0.05 y ser por tanto rechazable la hipotesis nula. Las medias de calidad del vino tinto y del blanco son significativamente diferentes desde un punto de vista estadístico.
